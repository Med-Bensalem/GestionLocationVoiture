                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="form-validation">
                                        <form method ="post" action="AjouterVoiture">
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        <label>Matricule</label>
                                                        <input type="text" class="form-control" name="matricule" placeholder="Saisie Matricule" autocomplete="off" required >
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Numéro carte Grise</label>
                                                        <input  class="form-control" type="text" placeholder="Saisie Numéro carte Grise" name="cartegrise"autocomplete="off" required>
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Kilométrage</label>
                                                        <input type="text" class="form-control" name="kilo" placeholder="Saisie Kilométrage " autocomplete="off">
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Date mise Circulation</label>
                                                         <input class="form-control" type="date" name ="dmc"value="2011-08-19" id="example-date-input">
                                                    </div>
